...
PHP_FCGID_CONF_FILE = fcgid.conf
...
BIND_CONF_FILE = /var/named/chroot/etc/named-easyscp.conf
...
CMD_FTPD = /etc/rc.d/init.d/proftpd
...
CMD_MTA = /etc/rc.d/init.d/postfix
...
CMD_EASYSCPD = /etc/rc.d/init.d/easyscp_daemon

CMD_EASYSCPN = /etc/rc.d/init.d/easyscp_network
