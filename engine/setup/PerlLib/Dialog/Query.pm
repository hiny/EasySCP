...
$VHOST = 'Please enter the domain name where EasySCP will be reachable on [%s]: ';
...
$DB_NAME = 'Please enter EasySCP SQL database name [easyscp]: ';

$DB_USER = 'Please enter EasySCP SQL user name [root]: ';

$DB_PASSWORD = 'Please enter EasySCP SQL password [none]: ';
$DB_PASSWORD_CONFIRM = 'Please repeat EasySCP SQL password: ';
$DB_PASSWORD_ERROR = 'Passwords do not match!';

$DB_FTP_USER = 'Please enter EasySCP FTP SQL user [vftp]: ';
$DB_FTP_USER_ERROR = 'FTP SQL user must not be identical to the EasySCP SQL user!';

$DB_FTP_PASSWORD = 'Please enter EasySCP FTP SQL user password [auto generate]: ';
$DB_FTP_PASSWORD_CONFIRM = 'Please repeat EasySCP ftp SQL user password: ';
$DB_FTP_PASSWORD_NOTICE = 'EasySCP ftp SQL user password set to: %s';
...
$DB_PMA_USER = 'Please enter EasySCP PMA control user [%s]: ';
$DB_PMA_USER_ERROR_1 = 'EasySCP PMA control user must not be identical to system SQL user!';
$DB_PMA_USER_ERROR_2 = 'EasySCP PMA control user must not be identical to FTP SQL user!';

$DB_PMA_PASSWORD = 'Please enter EasySCP PMA control user password [auto generate]: ';
$DB_PMA_PASSWORD_CONFIRM = 'Please repeat EasySCP PMA control user password: ';
